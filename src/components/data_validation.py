...
class DataValidation:
    ...
    def validate_numerical_columns(self, dataframe: pd.DataFrame) -> bool:
        """
        Validate that all numerical columns defined in the schema exist in the dataframe.
        """
        try:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            train_num_status = self.validate_numerical_columns(train_dataframe)
            test_num_status = self.validate_numerical_columns(test_dataframe)
